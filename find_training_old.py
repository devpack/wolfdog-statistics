...
def find_training(expr, offspr, the_country):
	...
	try:
		...
		table.setc(0, 3, "<i><u><b>TRAINING</b></u></i>")
		table.setc(0, 4, "<i><u><b>HIP</b></u></i>")
		table.setc(0, 5, "<i><u><b>BONITATION</b></u></i>")
		table.setc(0, 6, "<i><u><b>BIRTHDAY</b></u></i>")
		table.setc(0, 7, "<i><u><b>BREEDER</b></u></i>")
		table.setc(0, 8, "<i><u><b>ORIGIN COUNTRY</b></u></i>")
		...
		if expr[:6] == "regex:":
			...
			for elem in sorted_list:
				...
				if cond:
					...
					table.setc(i+line, 3, dump_dict[key]["TRAINING"].replace("data not available", "?"))
					...
					table.setc(i+line, 5, dump_dict[key]["BONITATION"].replace("data not available", "?"))
					...
					if dump_dict[key]["BREEDER"]!="data not available":
						table.setc(i+line, 7, "<a href=%s/find_breeders.py?name=%s>%s</a>"%(SERVER, dump_dict[key]["BREEDER"].replace(" ", "%20" ), dump_dict[key]["BREEDER"].replace("data not available", "?")))
					else:
